...
[source,xml]
----
include::extras/RecoveryManager-properties.xml[]
----

.orportability-properties.xml
[source,xml]
----
include::extras/orportability-properties.xml[]
----
...
[source,java]
----
include::extras/XAConnectionRecovery.java[]
----
...
[source,xml]
----
include::extras/ExpiryScanner-properties.xml[]
----
