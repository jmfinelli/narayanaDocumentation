...
[source,java]
----
include::extras/example-idl-interface.java[]
----
====
...
[source,java]
----
include::extras/example-DemoResource.java[]
----
====
...
[source,java]
----
include::extras/transactional-implementation.java[]
----
====
...
[source,java]
----
include::extras/DemoServer.java[]
----
====
...
[source,java]
----
include::extras/DemoClient.java[]
----
====
